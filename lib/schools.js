...
- Always end with: "Thank you for reaching out to Herrington International School! You can also email admissions@his.edu.kh or call (+855) 85 668 822."`,
  ...
  ciafirst: {
    ...
    appsScriptUrl: "https://script.google.com/macros/s/AKfycbxZ3UzLgiJuKy8x8kFbEY4OPEPOwo9t1VzZAp57aKCfPGchia5Pn0vqnN_gRo_vgrL4/exec",
    telegramBotTokenEnv: "CIA_BOT_TOKEN", // ← CIA FIRST's OWN Sheet + Apps Script /exec
...
- Always end with: "Thank you for reaching out to CIA FIRST International School! You can also email admissions@ciaschool.edu.kh or call +855 99 200 011."`,
  ...
  ais: {
    ...
    appsScriptUrl: "PASTE_YOUR_NEW_AIS_APPS_SCRIPT_URL_HERE", // ← new Sheet + Apps Script /exec for AIS
    telegramBotTokenEnv: "AIS_BOT_TOKEN",
    welcomeMessage: "សួស្តី! 👋 Welcome to American Intercon School. I can help with campuses, curriculum, tuition, and enrollment — in Khmer or English. Which campus or grade level are you interested in?",
...
CONVERSATION RULES:
- Greet warmly, ask the parent's name and which campus/grade they're enquiring about
- Keep responses concise — 2 to 4 short paragraphs max
